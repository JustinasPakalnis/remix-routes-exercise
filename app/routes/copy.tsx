...
export default function Events() {
  return (
    <div className="shadow-custom flex flex-col rounded-md border bg-white text-sm">
      <h2 className="border-b-[1px] p-3 py-4 text-[18px]">Events</h2>
      <div className="flex items-center justify-between">
        <div className="relative px-3 py-2">
          <svg
            className="absolute left-[20px] top-[15px] h-4 w-4 text-gray-500"
            viewBox="0 0 16 16"
            fill="none"
      ...
      <div className="flex">
        <div className="flex-[1.5] border-r-[1px] border-t-[1px]">
          <p className="bg-graybg flex items-center justify-between px-3 py-[11px] text-xs font-semibold text-gray-600">
            Timestamp
            <FaSort className="fill-graysort mr-1.5 size-3" />
          </p>
          <ul className="font-[350]">
            {events.map((event, index) => (
              <li
                key={index}
                className="border-t-[1px] px-3 py-2.5 underline-offset-4"
                style={{
        ...
        <div className="flex-[4] border-r-[1px] border-t-[1px]">
          <p className="bg-graybg px-3 py-[11px] text-xs font-semibold text-gray-600">
            Causer
          </p>
          <ul className="font-[350]">
            {events.map((event, index) => (
              <li key={index} className="border-t-[1px] px-3 py-2.5">
                {event.causer}
              </li>
            ))}
          </ul>
        ...
        <div className="flex-[1.05] border-r-[1px] border-t-[1px]">
          <p className="bg-graybg flex items-center justify-between px-3 py-[11px] text-xs font-semibold text-gray-600">
            Successful Event
            <FaSort className="fill-graysort mr-1.5 size-3" />
          </p>
          {events.map((_, index) => (
            <div
              key={index}
              className="flex justify-between border-t-[1px] px-3 py-2.5"
            >
