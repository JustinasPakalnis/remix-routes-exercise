    ...
    <>
      <div className="flex border rounded-md bg-white shadow-md">
        <div className="flex-1 border-r p-3">
          <span className="text-gray-500 text-xs">Maturity progress</span>
          <h2>8.33</h2>
        </div>
        <div className="flex-1 border-r p-3">
          <span className="text-gray-500 text-xs">Outstanding amount</span>
          <h2>1,165,801.60 TZS</h2>
        </div>
        <div className="flex-1 p-3">
          <span className="text-gray-500 text-xs">Maturity date</span>
          <h2>2025-11-21</h2>
        </div>
      </div>
      <div className="border rounded-md bg-white text-xs shadow-md">
        <div className="flex border-b-[1px] px-3 py-2">
